...
// Data from rfc3962 appendix B
var aesCbsCtsTests = []struct {
	key    string
	input  string
	output string
}{
	{"636869636b656e207465726979616b69", "4920776f756c64206c696b652074686520", "c6353568f2bf8cb4d8a580362da7ff7f97"},
	{"636869636b656e207465726979616b69", "4920776f756c64206c696b65207468652047656e6572616c20476175277320", "fc00783e0efdb2c1d445d4c8eff7ed2297687268d6ecccc0c07b25e25ecfe5"},
	{"636869636b656e207465726979616b69", "4920776f756c64206c696b65207468652047656e6572616c2047617527732043", "39312523a78662d5be7fcbcc98ebf5a897687268d6ecccc0c07b25e25ecfe584"},
	{"636869636b656e207465726979616b69", "4920776f756c64206c696b65207468652047656e6572616c20476175277320436869636b656e2c20706c656173652c", "97687268d6ecccc0c07b25e25ecfe584b3fffd940c16a18c1b5549d2f838029e39312523a78662d5be7fcbcc98ebf5"},
	{"636869636b656e207465726979616b69", "4920776f756c64206c696b65207468652047656e6572616c20476175277320436869636b656e2c20706c656173652c20", "97687268d6ecccc0c07b25e25ecfe5849dad8bbb96c4cdc03bc103e1a194bbd839312523a78662d5be7fcbcc98ebf5a8"},
	{"636869636b656e207465726979616b69", "4920776f756c64206c696b65207468652047656e6572616c20476175277320436869636b656e2c20706c656173652c20616e6420776f6e746f6e20736f75702e", "97687268d6ecccc0c07b25e25ecfe58439312523a78662d5be7fcbcc98ebf5a84807efe836ee89a526730dbc2f7bc8409dad8bbb96c4cdc03bc103e1a194bbd8"},
}

func TestAesCbsCtsEncryption(t *testing.T) {
	//fmt.Printf("XXX Testing AES encryption\n")
	for i, d := range aesCbsCtsTests {
		key := mustHexDecode(d.key)
		data := mustHexDecode(d.input)
		aescbcctsEncrypt(key, data)
		if !bytes.HasPrefix(data, mustHexDecode(d.output)) {
			t.Errorf("Test %d failed got %x expected %s\n", i, data, d.output)
			continue
		}
	}
